...
const Faq = () => {
    return (
        <div className="faq">
            <h1>General FAQ</h1>
            <div>
                <h3>I’d like to know about upcoming TEDxCMU events?</h3>
            ...
            <div>
                <h3>When and where is this year’s TEDxCMU event?</h3>
            ...
            <div>
                <h3>Will there be food? What are the lunch options?</h3>
            ...
            <div>
                <h3>Are kids allowed? Are there age minimums? Will teenagers like TEDxCMU?</h3>
            ...
            <div>
                <h3>Is there assigned seating or is it first come, first served? We bought different tiers of tickets, can we sit together? What about accessibility?</h3>
