...
class App extends Component {
  ...
  noMatch = () => {
      const error = 'Oh dear, this page is not available. Just use the menu on the right to navigate to safety! If you think this is a mistake, please don\'t call the police, we\'ll just fire our web developers.';
      return (
          <div>
              <Header
                  title="404: Not Found"
  ...
  sendFingerprintToFirestore = (type, id) => {
      const timeAccessed = moment().format('MMMM DD YYYY, h:mm:ss a');
      const db = fire.firestore();
